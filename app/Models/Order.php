...
class Order extends Model
{
    ...
    protected $fillable = ['order_number','customer_id','deliveryAddress_id', 'product_id', 'products','order_date', 'discount','total_amount','order_status','invoice_number','qty','size','metal','reason'];
